...
public class VideoEncoder implements Runnable {
    ...
    public void frameAvailable(SurfaceTexture st) {
        ...
        if (timestamp == 0) {
            ...
            MyLog.logd(TAG, "HEY: got SurfaceTexture with timestamp of zero");
            return;
        }
    ...
    public void run() {
        ...
        MyLog.logd(TAG, "Encoder thread exiting");
        synchronized (mReadyFence) {
    ...
    private static class EncoderHandler extends Handler {
        ...
        public void handleMessage(Message inputMessage) {
            ...
            if (encoder == null) {
                MyLog.logd(TAG, "EncoderHandler.handleMessage: encoder is null");
                return;
            }
     ...
     * Starts recording.
     */
    private void handleStartRecording(EGLContext eglContext) {
        MyLog.logd(TAG, "handleStartRecording ");
        mFrameNum = 0;
    ...
    private void handleStopRecording() {
        MyLog.logd(TAG, "handleStopRecording");
    ...
    private void handleSetTexture(int id) {
        MyLog.logd(TAG, "handleSetTexture " + id);
        mTextureId = id;
    }
